...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-5 pb-28">
      ...
      <Section eyebrow="09 · FULL TIME" title="The share, the flex, the proof">
        <p className="mb-6 max-w-lg text-sm text-text-muted">
          Match settles, the terrace freezes, your placement springs in with a pixel
          burst, points roll up, and the receipt is screenshot-ready. This is the loop that
          leaves the app: a card nobody can fake.
        </p>
